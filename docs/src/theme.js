...
const defStyle = {
    backgroundColor: hex2rgba(colors.defColor, 0.3),
    borderBottom: `1px solid ${hex2rgba(colors.black, 0.2)}`,
    color: colors.text,

    ':hover': {
        backgroundColor: colors.defColor,
        borderBottomColor: colors.text,
    },
};
...
const cssTheme = {
    ...
    markdown: {
        ...
        '& a:not(.anchor):not(.gatsby-resp-image-link) .definition': defStyle,
...
export { cssTheme, colors, media, fonts };